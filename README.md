...
# Submit your PR on this new repo [Hacktoberfest](https://github.com//rajdemon/Hacktoberfest2022), There we are merging all PR. 
...
```terminal
git clone https://github.com//rajdemon/HacktoberFest-2022.git
```
